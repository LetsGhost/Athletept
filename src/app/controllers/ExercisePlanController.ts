...
class ExercisePlanController {
  ...
  async createExercisePlan(req: Request, res: Response) {
    try {
      ...
      const { success, code, message, exercisePlan } =
        await exercisePlanService.createExercisePlanFromExcel(
          userId,
          exerciseFilePath,
          warmupFilePath
        );
  ...
  async createExercisePlanOnly(req: Request, res: Response) {
    try {
      ...
      const { success, code, message, exercisePlan } =
        await exercisePlanService.createExercisePlanOnly(
          userId,
          exerciseFilePath
        );
  ...
  async createWarmupOnly(req: Request, res: Response) {
    try {
        ...
        const { success, code, message, exercisePlan } =
          await exercisePlanService.createWarmupSingle(
            userId,
            warmupFilePath
          );
